<section id="contato" class="footer_with_form">
    ...
    <div class="form_and_text">
        ...
        <div class="footer_form_container">
            <form action="" class="footer_form">
                <input type="text" class="button input" placeholder="Nome">
                <input type="email" class="button input" placeholder="E-mail Empresarial">
                <input type="text" class="button input" placeholder="Cargo">
            </form>

            <button class="button footer_button">Enviar Contato</button>
        </div>
    ...
    <div class="credits">
        <p class="sub_title text">
            Brand Persona - 2022 - Todos os direitos reservados - Desenvolvido com ❤ por PYXYS
        </p>
    </div>